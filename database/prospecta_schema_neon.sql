-- ============================================
-- Prospecta — Esquema de base de datos
-- Neon / PostgreSQL 17
-- v1.2 · 2026
-- ============================================
...
-- ============================================
-- TABLA: templates (primero, sin dependencias)
-- ============================================
...
-- ============================================
-- TABLA: campaigns (depende de templates)
-- ============================================
...
-- ============================================
-- TABLA: prospects (depende de campaigns)
-- ============================================
...
-- ============================================
-- TABLA: messages (depende de prospects y campaigns)
-- ============================================
...
-- ============================================
-- TABLA: activity_log (depende de prospects)
-- ============================================
...
(
  ...
  'Hola [CONTACTO], he desarrollado una aplicación específica para empresas de climatización que simplifica la gestión de partes de conductos...'
),
(
  ...
  'Estimado/a [CONTACTO], me dirijo a usted para presentarle una solución diseñada específicamente para empresas instaladoras...'
),
(
  ...
  'Hola [CONTACTO], he desarrollado una plataforma de gestión energética orientada a empresas como la suya...'
);
